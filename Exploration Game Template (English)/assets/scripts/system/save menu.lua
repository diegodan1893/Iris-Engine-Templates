...
local tooltipStrings = {
	[modes.save] = "Click a save slot to save the game",
	[modes.load] = "Click a file to load",
	swap = "Click a save slot to move the file"
}

-- Confirmation dialogue
local confirmDialogText = {
	overwrite = "There is already a saved file, do you want to overwrite it?",
	delete = "Do you want to delete this file?",
	load = "Do you want to load this file?",
